...
function papernews_footer_logo_size()
{
    ...
    <style>
        ...
        .bs-headthree .bs-header-main .inner{
            background-color: <?php echo esc_attr(get_theme_mod('papernews_header_overlay_color',''))?>;
        }
...
function papernews_admin_scripts()
{
    ?>
    <style>
       
        li#accordion-section-frontpage_main_banner_section_settings::before {
            content: 'Frontpage Options';
        }
        li#accordion-section-frontpage_main_banner_section_settings {
            border-bottom: 2px solid #f5f5f5 !important;
            padding-bottom: 20px;
        }
    </style>
<?php } 
add_action('admin_enqueue_scripts','papernews_admin_scripts');